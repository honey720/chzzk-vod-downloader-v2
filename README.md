...
앱에 코드 서명이 없어서 처음 열면 "확인되지 않은 개발자" 경고와 함께 실행이 막힙니다. 처음 한 번만 허용하면 그다음부터는 평소대로 실행됩니다. 절차는 macOS 버전마다 조금씩 다르니 애플 공식 안내 **[알 수 없는 개발자의 Mac 앱 열기](https://support.apple.com/ko-kr/guide/mac-help/mh40616/mac)** 를 따라 주세요. 요약하면:
